...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        # Running Header
        self.drawString(54, 750, "LearnPulse AI — Week 4 Implementation Report (Domain Entities & User Core)")
...
def build_pdf(md_path, pdf_path):
    ...
    story.append(Paragraph("WEEK 4 IMPLEMENTATION REPORT", ParagraphStyle("CovType", fontName="Helvetica-Bold", fontSize=15, textColor=colors.HexColor("#0f172a"), spaceAfter=10)))
    story.append(Paragraph("Base Domain Entities, Student & Teacher Profile Services, SecurityContext Ownership Enforcement, Academic Hierarchy (Subjects & Chapters), Global Exception Handling, & RBAC Content Protection", ParagraphStyle("CovDesc", fontName="Helvetica", fontSize=10.5, leading=15, textColor=colors.HexColor("#475569"), spaceAfter=35)))
    ...
    meta_table_data = [
        ...
        [Paragraph("Document Title:", meta_label_style), Paragraph("Week 4 Implementation Report (Domain Entities & User Core)", meta_val_style)],
        [Paragraph("Official Phase:", meta_label_style), Paragraph("WEEK 4 IMPLEMENTATION (Git Branch: week-4-implementation)", meta_val_style)],
        [Paragraph("Technology Stack:", meta_label_style), Paragraph("Spring Boot 3.2.5, Java 21, Spring Security 6, PostgreSQL 16, pgvector 0.8.2", meta_val_style)],
        [Paragraph("Document Version:", meta_label_style), Paragraph("1.0.0-FINAL", meta_val_style)],
        [Paragraph("Report Date:", meta_label_style), Paragraph("August 19, 2026", meta_val_style)],
    ...
    while i < len(lines):
        ...
        if line.startswith("# WEEK 4 IMPLEMENTATION REPORT"):
            i += 1
            continue
...
if __name__ == "__main__":
    md_file = "/Users/krishnagarg/lms internship/WEEK_4_IMPLEMENTATION_REPORT.md"
    pdf_file = "/Users/krishnagarg/lms internship/WEEK_4_IMPLEMENTATION_REPORT.pdf"
